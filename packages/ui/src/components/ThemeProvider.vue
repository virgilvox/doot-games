...
/**
 * Applies a Doot theme: sets `data-theme` on the document root so token rules
 * take effect, and injects the generated theme stylesheet once. The TS token
 * objects in @doot-games/themes are the single source of truth. Wrap the app
 * (or any subtree) in this. See PRD section 9.
 */
