...
export const gameCatalog: GameCatalogEntry[] = [
  ...
  { id: 'tier-list', name: 'Tier List', version: '0.1.0', flagship: true, description: 'Build the S-to-D board together. The room decides where each one lands.', pool: { deckKind: 'prompt', placeholderBlock: 'tier' } },
