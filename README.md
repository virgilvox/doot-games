...
pnpm test                   # 375 tests (engine, blocks, scoring, derive, themes, markdown, schema-form); +2 opt-in live relay tests
pnpm -r typecheck
