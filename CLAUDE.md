...
| `packages/games` | `@doot-games/games` | blocks (guess/rate/poll/rank/draw/quip/vote/fill/split/bars/buzzer/fibvote/drawvote), the generic renderer, scoring knobs, and games as compositions |
