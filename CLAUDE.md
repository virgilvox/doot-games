...
| `packages/games` | `@doot-games/games` | the 20 blocks (guess/rate/poll/rank/draw/quip/vote/fill/split/bars/buzzer/fibvote/drawvote/hivemind/mostlikely/ballpark/faker/accuse/spotlight/cellar), the generic renderer, scoring knobs, and games as compositions |
