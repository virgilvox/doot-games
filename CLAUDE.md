...
| `packages/games` | `@doot-games/games` | the 19 blocks (guess/rate/poll/rank/draw/quip/vote/fill/split/bars/buzzer/fibvote/drawvote/hivemind/mostlikely/ballpark/faker/accuse/spotlight), the generic renderer, scoring knobs, and games as compositions |
