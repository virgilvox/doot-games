...
* "## answer": type-the-answer trivia (no choices; players TYPE it). Fields: subject, prompt, image, timer (default 30), "answers:" (the accepted answer; add synonyms split by " | ", e.g. "New York City | NYC"), "fuzzy:" (default yes, forgives typos/accents; set "no" for a strict match). Hidden until reveal; correct-only scoring. No "- " items (or use one "- item" as the answer).
